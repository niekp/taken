...
export default function Menu({ onClose, onLogout, currentUser, onUpdateUser, onOpenStats, onOpenDagschema, onOpenSchedules, onOpenAgenda, onOpenUserManagement, onOpenNotifications }) {
