...
export default function Menu({ onClose, onLogout, currentUser, onUpdateUser, onOpenStats, onOpenDagschema, onOpenAgenda, onOpenUserManagement, onOpenNotifications }) {
