...
router.get('/schedules/:id/notifications', scheduleController.getNotifications)
router.post('/schedules/:id/notifications', scheduleController.setNotification)
router.delete('/schedules/:id/notifications', scheduleController.removeNotification)
...
router.post('/tasks/:id/priority', taskController.setPriority)
...
router.put('/lists/:id/rename-category', listController.renameCategory)
router.delete('/lists/:id/delete-category', listController.deleteCategory)
router.put('/lists/:id/category-order', listController.updateCategoryOrder)
router.put('/lists/:id/reorder', listController.reorderItems)
